...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const elements = {
        ...
        flushButton: document.getElementById('btn-flush'),
    ...
    async function startRecording() {
        ...
        // Show flush button for debugging
        elements.flushButton.classList.remove('hidden');
    ...
    async function stopRecording() {
        ...
        elements.flushButton.classList.add('hidden');
